...
export function PanelTab(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'p' : _b, render = _a.render, props = tslib_1.__rest(_a, ["tag", "render"]);
    var className = classNames(tslib_1.__assign({}, getActiveModifiers(props)), props.className) || undefined;
...
var HOC = withHelpersModifiers(PanelTab);
export default HOC;

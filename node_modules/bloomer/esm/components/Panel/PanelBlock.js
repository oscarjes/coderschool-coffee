...
export function PanelBlock(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'div' : _b, render = _a.render, props = tslib_1.__rest(_a, ["tag", "render"]);
    var className = classNames('panel-block', tslib_1.__assign({ 'is-wrapped': props.isWrapped }, getActiveModifiers(props)), props.className);
    var isWrapped = props.isWrapped, rest = tslib_1.__rest(props, ["isWrapped"]);
    var HTMLProps = getHTMLProps(rest, removeActiveModifiers);
    if (render)
...
var HOC = withHelpersModifiers(PanelBlock);
export default HOC;

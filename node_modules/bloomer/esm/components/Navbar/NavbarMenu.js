...
export function NavbarMenu(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'div' : _b, props = tslib_1.__rest(_a, ["tag"]);
    var className = classNames('navbar-menu', tslib_1.__assign({}, getActiveModifiers(props)), props.className);
...
var HOC = withHelpersModifiers(NavbarMenu);
export default HOC;

...
export function NavToggle(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'span' : _b, props = tslib_1.__rest(_a, ["tag"]);
    var className = classNames('nav-toggle', tslib_1.__assign({}, getActiveModifiers(props)), props.className);
...
var HOC = withHelpersModifiers(NavToggle);
export default HOC;

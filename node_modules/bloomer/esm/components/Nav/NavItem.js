...
export function NavItem(_a) {
    ...
    var className = classNames('nav-item', tslib_1.__assign({ 'is-brand': props.isBrand, 'is-tab': props.isTab }, getActiveModifiers(props)), props.className);
...
var HOC = withHelpersModifiers(NavItem);
export default HOC;

...
import { isCentered, isFullWidth, isRight, withHelpersModifiers, } from './../../../bulma';
...
export function Field(_a) {
    ...
    var className = classNames('field', tslib_1.__assign({}, getModifier(props.isGrouped, 'is-grouped', isOption(isRight, isCentered)), getModifier(props.hasAddons, 'has-addons', isOption(isRight, isCentered, isFullWidth)), { 'is-horizontal': props.isHorizontal }), props.className);
...
var HOC = withHelpersModifiers(Field);
export default HOC;

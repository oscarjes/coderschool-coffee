...
export function Help(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'p' : _b, props = tslib_1.__rest(_a, ["tag"]);
    var className = classNames('help', tslib_1.__assign({}, getColorModifiers(props)), props.className);
    var HTMLProps = getHTMLProps(props, removeColorProps);
    return React.createElement(tag, tslib_1.__assign({}, HTMLProps, { className: className }));
}
var HOC = withHelpersModifiers(Help);
export default HOC;
